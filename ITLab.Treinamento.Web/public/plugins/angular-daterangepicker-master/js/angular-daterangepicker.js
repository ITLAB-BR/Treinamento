/*
* @by   fragaria
* @from https://github.com/fragaria/angular-daterangepicker
* 
* @modifiedBy      camilla.vianna@itlab.com.br
* @modifications   foram necessários alguns fixes para quando a opção é singleDatePicker
* 2019-02-07 - Marcelo Néias - FIX Bug SingleDatePicker set model object = null when input was null
*/
        ...
        return {
            ...
            link: function ($scope, element, attrs, modelCtrl) {
                ...
                modelCtrl.$render = function () {
                    ...
                    } else if (modelCtrl.$modelValue && opts.singleDatePicker) {
                        // FIX: for set single date by code
                        // without it, generate a unwanted range from date setted till today date (when date setted is before today)
                ...
                // FIX: from https://projects.ronasit.com/components/angular-daterangepicker/commit/ba3047be1c2a635954c3fd0d15e228963b3920d6?view=parallel
                if (opts.singleDatePicker) {
