...
{
    [Authorize]
    public class _ManageController : Controller
    {
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;

        public _ManageController()
        {
        }

        public _ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
