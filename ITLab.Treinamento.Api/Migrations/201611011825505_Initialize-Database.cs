    ...
    public partial class InitializeDatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        APIClientType = c.Byte(nullable: false),
                        Active = c.Boolean(nullable: false),
                ...
                .Index(t => t.Name, unique: true, name: "IX_APIClients_Name");
                ...
                c => new
                    {
                        ...
                        ChangeDate = c.DateTime(),
                        ChangeUser = c.String(unicode: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropIndex("AppSecurity.APIClients", "IX_APIClients_Name");
